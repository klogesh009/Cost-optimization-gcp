...
card.innerHTML = `<label style="cursor: pointer; display: flex; align-items: center;"> <input type="checkbox" value="${service.id}" onchange="toggleService('${service.id}')"> <span class="service-name">${service.name}</span> </label>`;
